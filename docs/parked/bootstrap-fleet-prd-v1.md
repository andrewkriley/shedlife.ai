---
Parked: former Bootstrap & Fleet Provisioning PRD. Superseded by docs/prd/bootstrap.md (Phase 1 intake) and awaiting a Deploy grill before any of this is source of truth again. Do not implement from this file.
---
# Bootstrap & Fleet Provisioning — PRD

Status: parked. Pair: [`bootstrap-fleet-spec-v1.md`](./bootstrap-fleet-spec-v1.md).
